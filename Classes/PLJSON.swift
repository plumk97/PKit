...
extension PLJSON {
    ...
    @discardableResult
    public func update(from: [String: Any]?) -> Self {
    ...
    public static func deserialize(from: [String: Any]?) -> Self {
...
open class JSON<T>: Property {
    ...
    public init(wrappedValue value: T, type: Any? = nil) {
