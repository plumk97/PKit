...
extension PLNavigationController {
    ...
    open class ContainerController: UIViewController, UIGestureRecognizerDelegate {
        ...
        open private(set) var conNavigationController: ContainerNavigationController!
        open private(set) var content: UIViewController!
        
        open private(set) var isNavigationBarHidden: Bool = false
        open private(set) var warpNavigationBar: WarpNavigationBar!
        
        open fileprivate(set) var isDisablePopGestureRecognizer = false
    ...
    open class ContainerNavigationController: UINavigationController {
...
extension PLNavigationController {
    ...
    open class WarpNavigationBar: UIView {
...
extension UINavigationController {
    ...
    open var pl_viewControllers: [UIViewController]? {
    ...
    open var pl_topViewController: UIViewController? {
        if let nav = self as? PLNavigationController {
    ...
    open var pl_visiableViewController: UIViewController? {
        if let nav = self as? PLNavigationController {
    ...
    open func pushViewController(_ viewController: UIViewController, animated: Bool, complete: PLNavigationController.Complete?) {
        if let nav = self as? PLNavigationController {
    ...
    open func popViewController(animated: Bool, complete: PLNavigationController.Complete?) -> UIViewController? {
        if let nav = self as? PLNavigationController {
            nav.transitionCompleteCallback = complete
    ...
    open func popToRootViewController(animated: Bool, complete: PLNavigationController.Complete?) -> [UIViewController]? {
        if let nav = self as? PLNavigationController {
            nav.transitionCompleteCallback = complete
    ...
    open func popToViewController(_ viewController: UIViewController, animated: Bool, complete: PLNavigationController.Complete?) -> [UIViewController]? {
        if let nav = self as? PLNavigationController {
            nav.transitionCompleteCallback = complete
...
extension PL where Base: UIViewController {
    ...
    public var navigationBar: PLNavigationController.WarpNavigationBar? {
...
@objc public protocol PLNavigationControllerConfig {
...
extension UIViewController: PLNavigationControllerConfig {
    open func pl_configNavigationCustomBackItemImage() -> UIImage? {
        return nil
    }
    
    open func pl_configNavigationCustomBackItem(target: Any, action: Selector) -> UIBarButtonItem? {
        return nil
    }
    
    open func pl_configNavigationBar(_ bar: UINavigationBar) {
        
    }
    
    open var pl_isDisablePopGestureRecognizer: Bool {
        get {
...
extension UIViewController {
    public var pl_containerContentViewController: UIViewController {
