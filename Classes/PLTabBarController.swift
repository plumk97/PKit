...
@objc public protocol PLTabBarControllerDelegate: NSObjectProtocol {
...
open class PLTabBarController: UIViewController {
    
    open weak var delegate: PLTabBarControllerDelegate?
    ...
    open private(set) var tabBar = PLTabBar()
...
extension PL where Base: UIViewController {
    public var tabBarController: PLTabBarController? {
