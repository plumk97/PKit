...
class PLMultimenuTableView: UITableView {
    ...
    @IBOutlet weak var multimenuDatasource: PLMultimenuDatasource?
...
class PLMultimenuAction: NSObject {
    ...
    convenience init(view: UIView?, backgroundColor: UIColor = .red, handler: Handler?) {
        self.init()
        self.view = view
...
@objc protocol PLMultimenuDatasource: NSObjectProtocol {
