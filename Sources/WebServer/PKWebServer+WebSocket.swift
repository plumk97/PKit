...
extension PKWebServer {
    ...
    class WebSocketHandler: ChannelInboundHandler, RemovableChannelHandler {
        ...
        func handlerAdded(context: ChannelHandlerContext) {
            let ctx = WebSocketContext.init(head: self.head, ctx: context)
            self.ctx = ctx
            
            PKWebServer.shared.webSocketReceivedCallback?(ctx)
        }
